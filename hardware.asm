...
DEF SCF_RQ     EQU SCF_START
DEF SCF_FAST   EQU SCF_SPEED
DEF SCF_MASTER EQU SCF_SOURCE
DEF SCF_SLAVE  EQU %00000000

DEF SCB_RQ     EQU SCB_START
DEF SCB_FAST   EQU SCB_SPEED
DEF SCB_MASTER EQU SCB_SOURCE
